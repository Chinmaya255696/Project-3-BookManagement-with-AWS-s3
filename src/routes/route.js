...
router.post("/books", commnMid.Authentication, commnMid.Auth, booksController.createBook)
...
router.put('/books/:bookId',commnMid.Authentication, commnMid.Auth, booksController.updateBook)
